...
| `synthesis` | Cochrane Ch 6, 10-11; tutorial pp. 9-15; statistical methods/software contract | Assess compatibility before pooling; prespecified estimand/effect scale, estimator/interval method, zero-event and dependency rules, heterogeneity/prediction interval, missing data, and sensitivity; NMA connectivity/transitivity/inconsistency/ranking uncertainty when applicable; reproducible results | Locked input snapshot; executable code/environment; `analysis_manifest.json`; results/diagnostics; synthesis report |
